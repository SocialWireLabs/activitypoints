...
$form .= "<h2><b>" . elgg_echo('activitypoints:export:import') . "</b></h2><br />";
...
$form .= elgg_view('input/submit', array('value' => elgg_echo("activitypoints:export:reset:submit_export_import")));
$form .= "<br><br><br>";
